...
<head>
    ...
    <link href="https://dervicheenzoemanuel.com.ar/css/fontawesome/css/all.min.css" rel="stylesheet">
    <link href="https://dervicheenzoemanuel.com.ar/css/fontawesome/css/fontawesome.min.css" rel="stylesheet">
</head>
<body>
    <div class="container">
        <div class="row">
            ...
            <div class="col-6">
                <form action="" method="POST">
                    <div class="row">
                        ...
                        <div class="col-12 form-group">
                            <label for="txtTelefono"><strong>Teléfono:</strong></label>
                        ...
                        <div class="col-12 form-group">
                            <label for="txtCorreo"><strong>Correo:</strong></label>
